...
set(CMAKE_ASM_FLAGS " -mthumb -mcpu=cortex-m1 -march=armv6-m -x assembler-with-cpp" CACHE INTERNAL "asm compiler flags")

# need to specify linker flags here
set(CMAKE_EXE_LINKER_FLAGS " -Wl,--gc-sections -Wl,--no-wchar-size-warning -mthumb -mcpu=cortex-m1 -march=armv6-m -mabi=aapcs -nostartfiles " CACHE INTERNAL "executable linker flags")
...
function(NF_SET_COMPILER_OPTIONS TARGET)
    ...
    target_compile_options(${TARGET} PUBLIC  ${ARGN} -march=armv6-m -mthumb -mcpu=cortex-m1 -mabi=aapcs -nostdlib -Wall -Wextra -Werror -ffunction-sections -fshort-wchar -falign-functions=16 -fdata-sections -fno-builtin -fno-common -fomit-frame-pointer -mlong-calls -fdollars-in-identifiers -fno-exceptions -fno-unroll-loops )

    # this series has FPU 
    target_compile_definitions(${TARGET} PUBLIC -DCORTEX_USE_FPU=FALSE -DUSE_FPU=FALSE) 
